	...
	<h3><?php _e( 'Access Keys', 'afrozaar_extras' ); ?></h3>
		 ...
		 <form method="post">
			...
			<table class="form-table">
				...
				<tr valign="top">
					<th width="33%" scope="row"><?php _e( 'Comment post Topic ARN:', 'afrozaar_extras' ); ?></th>
					<td>
						<input type="text" name="comment_post_topic" value="<?php echo $this->get_comment_post_topic() // xss ok; ?>" size="50" autocomplete="off" />
					</td>
				</tr>

				<tr valign="top">
					<th width="33%" scope="row"><?php _e( 'DynamoDB MojoSite config:', 'afrozaar_extras' ); ?></th>
					<td>
						<input type="text" name="mojo_site" value="<?php echo $this->get_mojo_site() // xss ok; ?>" size="50" autocomplete="off" />
					</td>
				</tr>
